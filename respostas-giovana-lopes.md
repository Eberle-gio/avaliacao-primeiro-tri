...
```text
Resposta Questão 3: A diferença entre Product Backlog e Sprint Backlog é que o Product backlog é a lista de tudo que o produto precisa ter enquanto a Sprint backlog são os itens escolhidos para serem desenvolvidos na sprint atual.
```
---
